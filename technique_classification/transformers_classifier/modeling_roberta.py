...
class RobertaForSequenceClassification(BertPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        if config.use_length:
            ...
            if config.use_matchings:
                self.classifier = RobertaClassificationHeadMatchings(config)
            else:
                self.classifier = RobertaClassificationHead(config)
    
    def forward(self, input_ids=None, attention_mask=None, token_type_ids=None, position_ids=None, head_mask=None, inputs_embeds=None, labels=None, lengths=None, matchings=None):
        outputs = self.roberta(input_ids,
                               attention_mask=attention_mask,
                               token_type_ids=token_type_ids,
                               position_ids=position_ids,
        ...
        logits = self.classifier(sequence_output, sent_a_length=lengths, attention_mask=attention_mask, matchings=matchings)
